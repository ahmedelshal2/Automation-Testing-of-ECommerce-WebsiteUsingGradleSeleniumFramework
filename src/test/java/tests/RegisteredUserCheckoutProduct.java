...
public class RegisteredUserCheckoutProduct extends TestBase {
	...
	String firstNName="ajeeed";
	String LastNName="peeeel";
	String emaill="ahsww55@gmail.com";
	String Passwordd="124643456";
	String productName="Apple MacBook Pro 13-inch";
	String country="Egypt";
	String City="fowaa";
	String address="deasouk";
	String zipCode="46233";
	String PhoneNumber="126666654";
